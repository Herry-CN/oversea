  ...
  const pillars = [
    {
      ...
      imgAlt: 'Advanced hardware and compliance engineering',
    },
    {
      number: '02',
      title: 'Hard Tech Native',
      subtitle: 'Built for Modern Products',
      desc: 'From AI-accelerated edge devices and smart home ecosystems to innovative consumer electronics and IoT hardware — we specialize in hard tech. Our playbooks are built on deep product knowledge, not generic export consulting.',
      img: 'https://images.unsplash.com/photo-1677442135703-1787eea5ce01?w=600&q=80',
      imgAlt: 'Modern consumer electronics and smart devices',
    },
    {
      number: '03',
